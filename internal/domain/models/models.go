...
var available = []Model{
	...
	{ID: "claude-opus-4-7", Name: "Claude Opus 4.7", Description: "Claude Opus 4.7"},
	{ID: "claude-opus-4-6", Name: "Claude Opus 4.6", Description: "Claude Opus 4.6"},
	{ID: "claude-opus-4-5-20251101", Name: "Claude Opus 4.5", Description: "Claude Opus 4.5"},
	{ID: "claude-sonnet-5", Name: "Claude Sonnet 5", Description: "Claude Sonnet 5"},
