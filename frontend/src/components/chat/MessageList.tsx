                ...
                if (msg.role === 'agent' && processedTurns) {
                    return (
                        <div className="flex flex-col gap-3 w-full">
                            ...
                            {/* モデル名の下に再生成・別モデル再生成・1応答全体読み上げボタンを並べる (画像生成ボタンはTURN毎のバブル内へ移設) */}
                            <div className="flex flex-col items-start gap-1 ml-1 mt-[-4px]">
                                {msg.model && (
                                ...
                                <div className="flex flex-wrap items-center gap-3">
                                    ...
                                    {isLast && !isLoading && sessionId && models.length > 0 && !altModelOpen && (
                                        ...
                                        >
                                            <RefreshCw size={12} />
                                            <span>{t(MESSAGE_LIST_I18N_KEYS.regenerateWithModel)}</span>
                                        </button>
                                    )}
