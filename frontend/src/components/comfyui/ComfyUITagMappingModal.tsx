...
import { X, Plus, Trash2, Search, Save, Tag, ArrowUpDown, ArrowUp, ArrowDown, Layers, List, Pencil, RefreshCw } from 'lucide-react';
import {
    getTagCategories,
    getTagMapping,
    saveTagMapping,
...
export const ComfyUITagMappingModal: React.FC<ComfyUITagMappingModalProps> = ({
    ...
    } = useComfyLoras(backendUrl, [selectedCategoryId], isOpen);
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50" onClick={onClose}>
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4 custom-scrollbar">
                    ...
                    {/* LoRAディレクトリ設定（インライン。ComfyUI 側のみ） */}
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="border border-gray-700 rounded-lg overflow-hidden">
                                    ...
                                    <div className="flex items-center bg-gray-800/70 px-3 py-1.5 text-xs text-gray-500 border-b border-gray-700">
                                        ...
                                        {isComfyBackend && <span className="w-16 text-center">LoRA</span>}
